...
**中文用途：** 本文件是 [SKILL.md](../SKILL.md) 的测试方法学详版。SKILL.md 给了总纲与判据；这里给**能直接照做的场景写法、完整 Checklist、元测技巧与完整例子**。做纪律类 skill 的测试时读它。
...
- The Bottom Line
- Real-World Impact
- 附：SKILL.md Structure 完整模板
- 附：Testing All Skill Types 完整判据
