...
name: ponytail
description: >
  Use whenever the user says "ponytail", "be lazy", "lazy mode", "simplest
  ...
  unnecessary dependencies. Also use when asked to strip a solution down or
  choose between a minimal and a fuller approach. Supports intensity levels:
