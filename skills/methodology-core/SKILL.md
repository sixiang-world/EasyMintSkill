...
description: >-
  需要以结构化方法论做 AI 编程编排、创建引导、多 Agent 协作、经验沉淀、
  权限治理或项目文档管理时使用。本 skill 为方法论核心包，承载主 Agent 的
  提示词体系、Agent 模板、多 Agent 委派编排、7 Gate 创建引导、工程化机制
  （权限/经验沉淀/上下文管理/系统消息/增强工具）与文档协议。
---
